...
typedef enum MemConsolePaneId {
    ...
    MEM_CONSOLE_PANE_RIGHT_DETAIL_META = 4,
    MEM_CONSOLE_PANE_RIGHT_DETAIL_CONNECTIONS = 5,
    MEM_CONSOLE_PANE_RIGHT_DETAIL_BODY = 6
} MemConsolePaneId;
...
typedef enum MemConsolePaneSplitterId {
    ...
    MEM_CONSOLE_PANE_SPLITTER_DETAIL_STACK = 3,
    MEM_CONSOLE_PANE_SPLITTER_DETAIL_TOP_ROW = 4
